...
public class Dosaggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitolo.setText(getResources().getString(R.string.dosaggi));
    ...
    void creaColtura(final String nomeColtura){
        ...
        buttonColtura.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), Dosaggio.class);
    ...
    public void logoutCliccato(MenuItem item) {
        ...
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Dosaggi.this);
